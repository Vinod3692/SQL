...
use june7;
create table watch(brand varchar(10),price int(10),color varchar(10),material varchar(10),waterresistant int(10),displaytype varchar(10),packof int(10),pawersource varchar(10),warranty int(10),dialcolor varchar(10));
create table fan(brand varchar(10),color varchar(10),material varchar(10),price int(10),sensor varchar(20),numberofblades int(10),bladematerial varchar(10),powerconsumption int(10),remote varchar(10),weight int(10));
create table laptop(brand varchar(10),processor varchar(10),operating_system varchar(10),ms_office varchar(10),price int(10),SSD_capacity int(10),cachetype int(10),number_of_cores int(10),touchscreen varchar(10));
create table friuts(fruit_name varchar(10),vitamin int(10),sugar int(10),size varchar(10),price int(10),taste varchar(10),weight int(10),ph_value int(10),color varchar(10),number_of_pack int(10));
create table chocolate(c_name varchar(10),with_nuts varchar(10),flavor varchar(10),amount int(10),gift_pack varchar(10),manufacture_date int(10),nutrient int(10),pack_of int(10),weight int(10),food_preference varchar(10));
create table door(made_of varchar(10),size int(10),weight int(10),height int(10),color varchar(10),glass varchar(10),design varchar(10),period_life int(10),handles int(10),locktype varchar(10));
create table bulding(b_name varchar(20),color varchar(10),number_of_rooms int(10),garden varchar(10),parking_slot int(10),height int(10),flowertype varchar(10),gate int(10),power_supply int(10),statue_name varchar(20));
create table bank(b_name varchar(10),location varchar(10),account_number int(20),ifsc_number int(20),branch  varchar(10),customer varchar(10),amount int(10),cash_counter int(10),manager_name varchar(10),atm_availability varchar(10));
create table school(s_name varchar(50),location varchar(20),number_of_students int(100),staff int(30),playground varchar(10),sports varchar(10),class int(10),parking_slot int(10),canteen int(10),stores_availability varchar(10));
